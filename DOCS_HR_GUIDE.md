...
> **\*Getting the Badge Hex Value**: This is a unique code that identifies each employee in the smartphone app. It typically looks like: `4872697468696B` and is autogenerated by the system
